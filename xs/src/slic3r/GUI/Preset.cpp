...
{    
    static std::vector<std::string> s_opts {
        ...
        "ooze_prevention", "standby_temperature_delta", "ooze_skirt_min_length", "interface_shells", "extrusion_width", "first_layer_extrusion_width",
...
{    
    ...
    if (s_opts.empty()) {
        s_opts = {
            ...
            "print_host", "printhost_apikey", "printhost_cafile", "use_firmware_retraction", "use_firmware_swap_retraction", "toolchange_use_filament_gcode",
