...
void GLCanvas3D::_load_print_toolpaths()
{
    ...
    size_t short_height = std::min<size_t>(print->config().skirt_height.value, total_layer_count);
    size_t skirt_height = print->has_infinite_skirt() ? total_layer_count : short_height;
    ...
    for (size_t i = 0; i < skirt_height; ++i) {
        ...
        _3DScene::extrusionentity_to_verts((i < short_height ? print->skirt() : print->tallSkirt()), print_zs[i], Point(0, 0), volume);
    }
